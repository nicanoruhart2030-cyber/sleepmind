  ...
  return (
    <div>
      <button
        ...
        disabled={loading}
        className="flex h-9 w-full items-center justify-center gap-2 rounded-lg border border-[rgba(0,0,0,0.12)] bg-white text-sm font-medium text-[#0A0A0B] transition-colors hover:bg-[#F9F9F9] disabled:opacity-60"
      >
        <GoogleGlyph />
